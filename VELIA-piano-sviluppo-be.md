...
- Test: `test/integrazione-crediti.spec.ts` (3: saldo e catalogo, addebito proporzionale con minimo e riserva per classe, eccedenza sui pacchetti e 429). Il tenant demo è partito da 600 il 25/08.
