...
const MOVIMENTI = [
  { id: 'crd-010', tipo: 'addebito', crediti: -10.4, tokenInput: 148200, tokenOutput: 5100, costoUsd: 0.416, operazione: 'risposta', modello: 'claude-opus-5', descrizione: 'Risposta in chat: Confronta il set informativo AUTOPIÙ con il preventivo…', istante: '2026-08-24T16:12:00+02:00' },
  ...
  { id: 'crd-008', tipo: 'addebito', crediti: -0.4, tokenInput: 61000, tokenOutput: 2100, costoUsd: 0.109, operazione: 'risposta', modello: 'zai-org/GLM-5.2', descrizione: 'Risposta in chat: Che franchigia prevede la garanzia cristalli?', istante: '2026-08-23T17:05:00+02:00' },
  { id: 'crd-011', tipo: 'addebito', crediti: -0.6, tokenInput: 9800, tokenOutput: 120, costoUsd: 0.024, operazione: 'risposta', modello: 'claude-opus-5', descrizione: 'Risposta in chat: Ciao, chi sei?', istante: '2026-08-24T09:02:00+02:00' },
...
const RIEPILOGO = {
  saldo: { inclusi: 600, inclusiUsati: 52.4, acquistati: 1000, acquistatiUsati: 0, disponibili: 1547.6 },
  pesi: PESI,
  meseCorrente: { risposta: 11.4, tabella: 30, agente: 10, conversione: 1 },
  movimenti: MOVIMENTI,
};
