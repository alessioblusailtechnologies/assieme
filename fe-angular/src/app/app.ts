...
import { Conferma } from '@shared/ui/conferma/conferma';
 ...
 * notifiche, la finestra di conferma e — fuori dalla produzione — il
 * pannello di sviluppo. La
...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Conferma, Notifiche, PannelloSviluppo],
