...
describe.skipIf(!pronto)('archivio pubblico col progetto Supabase', () => {
  ...
  it('elenco: busta {elementi, totale, pagina, perPagina} con le fixture', async () => {
    ...
    /* 105 Unipol (19 prodotti: i 9 set auto ed. 05/2026 entrati il 12/09/2026, le due edizioni storiche di Km&Servizi Autovetture, Scudo Cyber in due edizioni, 3 Focus Commercio, i 3 set già trascritti entrati il 13/09/2026: Tutela Legale Aziende ed. 03/2026, Unica Infortuni e Unica Casa ed. 10/2025, piu Tutela Legale Professionisti ed. 03/2026 e Unica Famiglia ed. 10/2025) + 3 Cattolica AUTOPIÙ (ed. 07/2025) + 60 Nobis (8 prodotti, 15 edizioni) + 30 Allianz (5 prodotti, 10 edizioni) + 22 AXA (6 set) + 51 Zurich (16 prodotti, 17 edizioni: auto, casa, infortuni, salute, viaggi) + 20 HDI (6 set auto) + 34 Generali (9 set: 2 contratti base, Sei in Viaggio, Immagina Strade Nuove e Passione Moto, ViviCondomìnio e i tre moduli di Immagina Adesso - Casa, Armonia e Cucciolo, ognuno con le Norme comuni replicate) + 15 Groupama (5 set auto entrati il 13/09/2026). */
    expect(pagina.totale).toBe(340);
